...
First, the files listed in "require_files" are required.  Then the MyWorker class is called to 
do the work.  Now two independent sets of loops are using the same class MyWorker customized by 
